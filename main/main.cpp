...
int main(void) 
{
 ...
 mat Y;
 vec vnan;
 double from_lag,max_lag,alpha;
 string direction;
 uli nsim;
 bool flg_const,flg_diff,flg_print;
 ...
 out=regpred_cpp(&Y, from_lag, max_lag, alpha, nsim, flg_print, direction, loss_function, pred_only, flg_const, flg_diff, h, vmodels);
